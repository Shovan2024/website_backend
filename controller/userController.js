...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    resumeURL,
    avatar: {
      public_id: cloudinaryResponseForAvatar.public_id, // Use the correct properties
      url: cloudinaryResponseForAvatar.secure_url, // Use the correct properties
    },
    resume: {
      public_id: cloudinaryResponseForResume.public_id, // Use the correct properties
      url: cloudinaryResponseForResume.secure_url, // Use the correct properties
    },
  });
...
export const getUserForPortfolio = catchAsyncErrors(async (req, res, next) => {
  const id = "667839b5808a6788c4966e12";
